	...
	<div class="inner">
		...
		<ul class="col-5 line-list">
			...
			<li class="num" data-num="03">
				<img src="<? echo G5_THEME_IMG_URL; ?>/sub/jaw_point_06.jpg" alt="">
				<h5>레이저 / 적외선</h5>
				<p>중주파 물리치료를 통해 근경련, 
...
<section class="content">
	<div class="inner">
		<h4 class="middle-title">턱관절 치료과정</h4>
		<ul class="basic-box">
			<li><img src="<? echo G5_THEME_IMG_URL; ?>/sub/about_01.jpg" alt=""></li>
			<li class="num" data-num="01">
				<h5>턱 관절 정밀검사</h5>
				<p>파노라마 X-ray와 CT촬영으로
                환자의 현재 턱관절 상태를 정밀하게 검사합니다.
                </p>
			</li>
		</ul>
		<ul class="basic-box">
			...
			<li class="num" data-num="02">
				...
				<h5>정확한 상태 진단</h5>
				<p>검사 결과를 바탕으로 진단 및 치료 계획을 설정합니다.</p>
			</li>
		</ul>
		<ul class="basic-box">
...
<section class="content">
	<div class="inner joint04">
		<h4 class="middle-title">연세원플란트 턱관절치료의 특별함</h4>
