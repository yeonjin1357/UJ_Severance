...
<!-- <section class="content">
	<div class="inner">
		<h4 class="middle-title">심미보철 CASE</h4>
		<ul class="col-2 aesthetic">
			<li>
				<img src="<? echo G5_THEME_IMG_URL; ?>/sub/aesthetic_04.jpg" alt="">
				<h5>BEFORE</h5>
			</li>
			<li>
				<img src="<? echo G5_THEME_IMG_URL; ?>/sub/aesthetic_05.jpg" alt="">
				<h5 class="point-color">AFTER</h5>
			</li>
			<li>
				<img src="<? echo G5_THEME_IMG_URL; ?>/sub/aesthetic_06.jpg" alt="">
				<h5>BEFORE</h5>
			</li>
			<li>
				<img src="<? echo G5_THEME_IMG_URL; ?>/sub/aesthetic_07.jpg" alt="">
				<h5 class="point-color">AFTER</h5>
			</li>
		</ul>
	</div>
