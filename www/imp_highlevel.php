...
<meta name="description" content="파주뼈이식임플란트, 운정뼈이식임플란트">
<meta name="keywords" content="파주뼈이식임플란트, 운정뼈이식임플란트">
<!-- 오픈그래프 태그, 소셜 미디어로 공유될 때 우선적으로 활용 -->
<meta property="og:type" content="website">
<meta property="og:title" content="파주뼈이식임플란트, 운정뼈이식임플란트">
<title>파주뼈이식임플란트, 운정뼈이식임플란트</title>
...
<section class="content">
	<div class="inner">
		<div class="title pb0">
			...
			뼈의 양이 부족한 경우 뼈를 형성하는<br />단백질 (BMP)로 이루어진 뼈이식재를 
...
<section class="content bg-color">
	<div class="inner">
        <h4 class="middle-title">뼈이식 임플란트 CASE</h4>
		<ul class="col-2 line-list">
			<li>
                <img src="<? echo G5_THEME_IMG_URL; ?>/sub/imp_highlevel_04.jpg" alt="">
				<span>BEFORE</span>
			</li>
			<li>
                <img src="<? echo G5_THEME_IMG_URL; ?>/sub/imp_highlevel_05.jpg" alt="">
				<span>AFTER</span>
			</li>
		</ul>
        <p class="middle-text">극단적 골 흡수 상악동 골이식술 사례입니다.</p>
        <ul class="col-2 line-list">
			<li>
                <img src="<? echo G5_THEME_IMG_URL; ?>/sub/imp_highlevel_06.jpg" alt="">
				<span>BEFORE</span>
			</li>
			<li>
                <img src="<? echo G5_THEME_IMG_URL; ?>/sub/imp_highlevel_07.jpg" alt="">
				<span>AFTER</span>
			</li>
		</ul>
        <p class="middle-text">양악수술 환자의 상악동 골이식 사례입니다.</p>
        <ul class="col-2 line-list">
			<li>
                <img src="<? echo G5_THEME_IMG_URL; ?>/sub/imp_highlevel_08.jpg" alt="">
				<span>BEFORE</span>
			</li>
			<li>
                <img src="<? echo G5_THEME_IMG_URL; ?>/sub/imp_highlevel_09.jpg" alt="">
				<span>AFTER</span>
			</li>
		</ul>
		<p class="middle-text">광범위 골이식 임플란트 재건</p>
	</div>
</section>
...
<style>
	...
	.bg-color{padding-bottom: 3% !important;}
</style>
